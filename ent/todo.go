...
func (td *ToDo) Value(name string) (ent.Value, error) {
...
func (td *ToDo) Update() *ToDoUpdateOne {
	return NewToDoClient(td.config).UpdateOne(td)
}
...
func (td *ToDo) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", td.IsDone))
	builder.WriteString(", ")
	builder.WriteString("context=")
	builder.WriteString(td.Context)
	builder.WriteString(", ")
